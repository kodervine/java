...
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD) // ensures that context is cleaned, eg database is cleared for
// each test runs
public class AuthorRepositoryIntegrationTests {
    ...
    public void testThatAuthorCanBeCreatedAndRecalled(){
        ...
        // readable and informative failing messages
    ...
    public void testThatGetAuthorsWithAgeGreaterThan() {
        ...
        Iterable<Author> result = underTest.findAuthorsWithAgeGreaterThan(40);
